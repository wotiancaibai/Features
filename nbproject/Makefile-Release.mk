...
${OBJECTDIR}/sift.o: sift.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 `pkg-config --cflags opencv` `pkg-config --cflags gtk+-2.0` `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/sift.o sift.c
...
${OBJECTDIR}/utils.o: utils.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 `pkg-config --cflags opencv` `pkg-config --cflags gtk+-2.0` `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/utils.o utils.c
