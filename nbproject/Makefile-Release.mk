...
${OBJECTDIR}/feature.o: feature.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/feature.o feature.c
...
${TESTDIR}/tests/featureUnitTest.o: tests/featureUnitTest.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/featureUnitTest.o tests/featureUnitTest.c


${TESTDIR}/tests/imageUnitTest.o: tests/imageUnitTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/imageUnitTest.o tests/imageUnitTest.c


${TESTDIR}/tests/toolsUnitTest.o: tests/toolsUnitTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/toolsUnitTest.o tests/toolsUnitTest.c
...
${OBJECTDIR}/image_nomain.o: ${OBJECTDIR}/image.o image.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/image_nomain.o image.c;\
	else  \
...
${OBJECTDIR}/feature_nomain.o: ${OBJECTDIR}/feature.o feature.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/feature_nomain.o feature.c;\
	else  \
